...
def datagen_Hamiltonian_TBR_controller():
    ...
    path_config = os.path.join(params["data_path"], "datagen_Hamiltonian_TBR_controller_config_" + time_str + ".txt")
    ...
    for traj_num in range(params["num_trajs"]):
        ...
        ephem_filename = "test_TBR_ephem_traj_seed_" + str(seed_traj) + "_tof_" + tof_scale_str
