...
PATH_REPLACEMENTS = {
    ...
    "src/scripts/ingest_ephem_and_plot.py": [
        ('"data\\test_data\\"', 'os.path.join("data", "test_data")'),
    ],
    ...
    "src/scripts/train_alpha_network.py": [
        ...
        ('"..\\\\data\\\\plots\\\\"', 'os.path.join("..", "data", "plots", "")'),
        (
            '"..\\\\data\\\\neural_networks\\\\"',
            'os.path.join("..", "data", "neural_networks", "")',
        ),
    ...
    "tests/test_write_ephemeris.py": [
        (
            '"..\\\\..\\\\data\\\\training_ephems\\\\"',
            'os.path.join(DATA_ROOT, "training_ephems", "")',
        ),
    ],
    ...
    "tests/test_random_env_reset.py": [
        (
            ...
            'os.path.join(DATA_ROOT, "test_data", "test_random_TBT_transfer_report.csv")',
        ),
    ],
    ...
    "tests/test_eom_and_propagation.py": [
        (
            ...
            'os.path.join(DATA_ROOT, "plots", "states_nd.pdf")',
        ),
        (
            '"..\\\\..\\\\data\\\\plots\\\\costates_nd.pdf"',
            'os.path.join(DATA_ROOT, "plots", "costates_nd.pdf")',
        ),
    ],
...
def migrate_file(filepath: str, replacements: list, dry_run: bool = False) -> bool:
    ...
    for i, line in enumerate(lines):
        ...
        for match in matches:
            ...
            if "\\" in match and any(
                indicator in match for indicator in path_indicators
            ):
